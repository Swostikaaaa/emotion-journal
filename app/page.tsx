  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-2xl w-full glass-card p-8 md:p-12 text-center floating">
        ...
        <p className="bg-white/10 backdrop-blur-sm text-gray-200 text-sm px-3 py-1 rounded-full inline-block mt-6">
          ✨ Demo mode lets you explore without creating an account
        </p>
      </div>
    </div>
  );
