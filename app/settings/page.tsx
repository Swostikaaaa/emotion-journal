...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    const confirmed = confirm(
      'Are you sure you want to delete your account? This action is permanent and will erase all your journal entries.'
    );
    if (!confirmed) return;
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass-card p-8" style={{ backgroundColor: 'rgba(59, 130, 246, 0.25)' }}>
          <h1 className="text-3xl font-bold text-white mb-2">Account Settings</h1>
          <p className="text-white/70 mb-8">Manage your password and account</p>
          ...
          <div className="mb-6 p-4 bg-white/10 rounded-lg">
            ...
            {isDemoUser && (
              <p className="text-xs text-white/50 mt-1">
                Demo account – entries are cleared on each login
              </p>
            )}
          </div>

          {message && (
            <div className="bg-green-500/20 text-green-200 p-3 rounded-lg mb-6 text-sm">
              {message}
            </div>
          )}
          {error && (
          ...
          <div>
            ...
            <p className="text-white/70 mb-4">
              Once you delete your account, there is no going back. All your journal entries will be
              permanently removed.
            </p>
            {isDemoUser && (
              <p className="text-amber-300 text-sm mb-3">
                ⚠️ Demo accounts cannot be deleted.
              </p>
            )}
            <button
